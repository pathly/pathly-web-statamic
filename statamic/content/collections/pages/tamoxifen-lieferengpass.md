...
description:
  -
    ...
    content:
      -
        type: text
        text: 'Hier ist ein Einleitungstext. '
  -
    type: paragraph
    content:
      -
...
content:
  -
    ...
    content:
      -
        type: text
        text: 'Seit Januar 2022 besteht in Deutschland ein Lieferengpass von Tamoxifen, ein Arzneimittel, das hauptsächlich zur Antihormontherapie bei Brustkrebs eingesetzt wird. Laut der Deutschen Gesellschaft für Hämatologie und Medizinische Onkologie sind 120.000-130.000 Patient:innen von dem Tamoxifen-Engpass betroffen. Deswegen haben wir mit dem '
      -
        type: text
        marks:
          -
      ...
      -
        type: text
        text: ' gesprochen. Die Mitarbeiter:innen dort nehmen die Sorgen, Ängste und auch Verständnislosigkeit der betroffenen Patient:innen sehr ernst und arbeiten mit Hochdruck an einer Lösung, damit niemand unversorgt bleibt. Am 09. Februar haben die zuständigen Behörden Maßnahmen beschlossen, um die Patient:innen ausreichend zu versorgen. Nach aktuellen Angaben der Behörden genügend verfügbaren Mengen an Tamoxifen in Deutschland, um eine Versorgung der Betroffenen bis zum Ende des Lieferengpasses zu gewährleisten.'
  -
    type: heading
    attrs:
      level: 2
